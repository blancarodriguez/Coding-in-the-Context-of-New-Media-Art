...
//Set the size of the stage, and the background to dark blue.
size(550,550);
background(25, 51, 77);  
...
queryForTwitter = new Query("#liberal, liberal, cuck, #cuck"); 
...
// use the tweets to make a drawing!
  ...
  {
    if (word.toLowerCase().contains("snowflake"))
    {
      //every time you find the word "snowflake" draw an ellipse and print "special snowflake" in the console
